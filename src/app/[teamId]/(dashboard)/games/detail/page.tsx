  ...
  return (
    <div className="px-4 py-4 space-y-4 pb-20">
      ...
      <div className="flex gap-2">
        ...
        {canViewStaff && <button onClick={handleShare} className="flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl border border-border bg-surface text-[13px] font-bold text-muted active:bg-surface-variant transition-all shadow-sm touch-active"><Share2 className="w-4 h-4" />共有</button>}
      </div>
